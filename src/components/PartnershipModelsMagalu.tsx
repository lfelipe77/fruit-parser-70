  ...
  const models = [
    {
      ...
      description: "Continuar listando produtos Magazine Luiza como ganháveis (junto a outros parceiros).",
    ...
    },
    {
      ...
      description: "Magazine Luiza integra o Ganhavel.com à sua rede de influenciadores e parceiros estratégicos.",
      details: "Influenciadores promovem produtos Magazine Luiza como ganháveis, unindo conteúdo + gamificação + venda fracionada por sorteio.",
    ...
    },
    {
      ...
      description: "\"Ganhavel by Magazine Luiza\": total exclusividade, controle e decisões estratégicas alinhadas à marca/produtos.",
          ...
          <CardContent>
            <div className="text-center">
              ...
              <p className="text-lg opacity-90 mb-6">
                Casa completa Magazine Luiza + collabs exclusivos com visual aspiracional
              </p>
...
export default PartnershipModelsMagalu;