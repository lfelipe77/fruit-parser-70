...
const NextStepsSectionMagalu = () => {
  const steps = [
    {
      number: 1,
      icon: PlayCircle,
      title: "Testar o Ganhavel",
      description: "Gostaria de convidar o time da Magazine Luiza para lançarem um ganhável simples (R$ 9–10), comprarem bilhetes e conferirem o funcionamento. Qualquer gasto, faço questão de reembolsar imediatamente. 🙂",
    ...
    },
    {
      number: 3,
      icon: Rocket,
      title: "Piloto com produto Magazine Luiza",
      description: "Ativar influenciadores e acompanhar a dinâmica gamificada com produto real da Magazine Luiza.",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-16 text-center">
          <Card className="p-8 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 text-white">
            <CardContent>
              <h3 className="text-2xl font-bold mb-4">Adoraríamos saber a opinião do time Magazine Luiza</h3>
...
export default NextStepsSectionMagalu;