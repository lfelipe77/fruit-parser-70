...
const FounderVisionSectionMagalu = () => {
            ...
            <Card className="p-8 bg-gradient-to-r from-purple-600 via-blue-600 to-purple-800 text-white">
              <CardContent>
                ...
                <p className="text-lg leading-relaxed opacity-95">
                  Um novo canal de vendas, engajamento e conteúdo, capaz de consolidar a Magazine Luiza 
...
export default FounderVisionSectionMagalu;